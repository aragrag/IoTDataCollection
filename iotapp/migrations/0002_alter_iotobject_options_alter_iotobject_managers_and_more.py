...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='iotobject',
            name='groups',
            field=models.ManyToManyField(related_name='iot_objects', to='auth.group'),
        ),
        migrations.AddField(
            model_name='iotobject',
            name='is_active',
        ...
        migrations.AddField(
            model_name='iotobject',
            name='password',
            field=models.CharField(default=2084776, max_length=128, verbose_name='password'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='iotobject',
            name='user_permissions',
            field=models.ManyToManyField(related_name='iot_objects', to='auth.permission'),
        ),
        migrations.AddField(
            model_name='iotobject',
            name='username',
